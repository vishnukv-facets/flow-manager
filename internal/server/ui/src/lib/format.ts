...
// free, and shows the EXACT dollars-and-cents for large sums too — grouped with
// thousands separators ($1,002.49) rather than compacted to "$1.0k", so the
// operator can read true spend, not a rounded-to-the-thousand figure.
